...
(
    ...
    CONSTRAINT banks_history_action_by_fkey FOREIGN KEY (action_by)
        ...
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
    CONSTRAINT banks_history_user_id_fkey FOREIGN KEY (past_action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL
);
...
(
    ...
    CONSTRAINT companies_history_action_by_fkey FOREIGN KEY (action_by)
        ...
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
    CONSTRAINT companies_history_user_id_fkey FOREIGN KEY (past_action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL
);

CREATE TABLE IF NOT EXISTS public.countries_history
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    CONSTRAINT countries_history_action_by_fkey FOREIGN KEY (action_by)
        ...
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
    CONSTRAINT countries_history_user_id_fkey FOREIGN KEY (past_action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL
);

CREATE TABLE IF NOT EXISTS public.currencies_history
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    name character varying(10) COLLATE pg_catalog."default",
    ...
    action_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    currency_id integer,
    CONSTRAINT currencies_history_pkey PRIMARY KEY (id),
    CONSTRAINT currencies_history_action_by_fkey FOREIGN KEY (action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
    CONSTRAINT currencies_history_user_id_fkey FOREIGN KEY (past_action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL
);

CREATE TABLE IF NOT EXISTS public.destinations_history
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    name character varying(50) COLLATE pg_catalog."default",
    country_id integer,
    ...
    CONSTRAINT destinations_history_action_by_fkey FOREIGN KEY (action_by)
        ...
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
    CONSTRAINT destinations_history_user_id_fkey FOREIGN KEY (past_action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS public.fabrics_history
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    fabrics_id integer,
    name text COLLATE pg_catalog."default",
    ...
    CONSTRAINT fabrics_history_action_by_fkey FOREIGN KEY (action_by)
        ...
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
    CONSTRAINT fabrics_history_user_id_fkey FOREIGN KEY (past_action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS public.overseas_office_history
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    action_by uuid,
    action_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT overseas_office_history_pkey PRIMARY KEY (id),
    CONSTRAINT overseas_office_history_action_by_fkey FOREIGN KEY (action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS public.payment_terms_history
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    action_by uuid,
    action_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT payment_terms_history_pkey PRIMARY KEY (id),
    CONSTRAINT payment_terms_history_action_by_fkey FOREIGN KEY (action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
...
(
    ...
    action_by uuid,
    action_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT products_history_pkey PRIMARY KEY (id),
    CONSTRAINT products_history_action_by_fkey FOREIGN KEY (action_by)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
